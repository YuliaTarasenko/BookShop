...
namespace BookShop.Data.Migrations
{
    ...
    [Migration("20211114172348_fluent & API, Repositories")]
    partial class fluentAPIRepositories
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShop.Models.Discount", b =>
                {
                    ...
                    b.HasIndex("IsPercent");

                    b.HasIndex("Reduction");
            ...
            modelBuilder.Entity("BookShop.Models.PublishingCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookShop.Models.Storage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookGenre", b =>
                {
                    ...
                    b.HasOne("BookShop.Models.Genre", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookShop.Models.Autor", b =>
                {
                    b.HasOne("BookShop.Models.PublishingCompany", "Publisher")
                        .WithMany("Autors")
            ...
            modelBuilder.Entity("BookShop.Models.Order", b =>
                {
                    b.HasOne("BookShop.Models.Discount", "Discount")
                        .WithMany()
                        .HasForeignKey("DiscountId");

                    b.HasOne("BookShop.Models.Storage", "Storage")
                        .WithMany()
            ...
            modelBuilder.Entity("BookSubject", b =>
                {
                    ...
                    b.HasOne("BookShop.Models.Subject", null)
                        .WithMany()
